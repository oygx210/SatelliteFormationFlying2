...
BEGIN Scenario
    ...
    BEGIN Epoch
        ...
        Epoch		 16 Aug 2021 00:00:00.000000000
        SmartEpoch		
        BEGIN EVENT
            Epoch		 16 Aug 2021 00:00:00.000000000
            EventEpoch		
...
"16 Aug 2021 00:00:00.000000000" "17 Aug 2021 00:00:00.000000000"
                        END Intervals
    ...
    BEGIN Extensions
        ...
        BEGIN ClsApp
            ...
            LaunchWindowStart		 -23382000
            LaunchWindowStop		 -23382000
            LaunchMETOffset		 0
            ...
            BEGIN EVENTINTERVAL
                BEGIN Interval
                    Start		 18 Nov 2020 09:00:00.000000000
                    Stop		 19 Nov 2020 09:00:00.000000000
                END Interval
        ...
        BEGIN ReportFavorites
            BEGIN Class
                ...
                BEGIN Favorite
                    Type		 Report
                    BaseDir		 User
                    Style		 Place Cartesian Position
                END Favorite
            END Class
            BEGIN Class
                Name		 Planet
                BEGIN Favorite
                    Type		 Report
                    BaseDir		 User
                    Style		 Earth_Position_heliocentric
                END Favorite
                BEGIN Favorite
                    Type		 Report
                    BaseDir		 User
                    Style		 Earth_Position
                END Favorite
                BEGIN Favorite
                    Type		 Report
                    BaseDir		 User
...
<SCOPE>
    <VAR name = "ClutterMap">
        ...
        BEGIN Graphics
            ...
            BEGIN Animation
                ...
                StartTime		 16 Aug 2021 00:00:00.000000000
                EndTime		 17 Aug 2021 00:00:00.000000000
                CurrentTime		 16 Aug 2021 00:00:00.000000000
                Direction		 Forward
                UpdateDelta		 30
                ...
                BEGIN MapStyles
                    ...
                    BEGIN Style
                        ...
                        BEGIN RecordMovie
                            OutputFormat		 WMV
                            SdfSelected		 No
                            Directory		 D:\Documents\education\STK class\Target_orbits
                            BaseName		 Frame
                            Digits		 4
                            Frame		 0
                            LastAnimTime		 0
    ...
    BEGIN References
        Instance *
            *		
            Chain/Chain_target_orbit2POI		
            Constellation/Constellation1		
        END Instance
        Instance Chain/Chain_target_orbit2POI
            Chain/Chain_target_orbit2POI		
        END Instance
        ...
        END Instance
        Instance Satellite/Satellite5
            Constellation/Constellation1		
            Satellite/Satellite5		
        END Instance
        Instance Satellite/Satellite7
            Constellation/Constellation1		
            Satellite/Satellite7		
        END Instance
        Instance Satellite/Satellite8
            Constellation/Constellation1		
            Satellite/Satellite8		
        END Instance
        Instance Satellite/Satellite9
            Constellation/Constellation1		
            Satellite/Satellite9		
        END Instance
        Instance Satellite/Target_orbit
            Chain/Chain_target_orbit2POI		
            Constellation/Constellation1		
            Satellite/Target_orbit		
        END Instance
    END References
