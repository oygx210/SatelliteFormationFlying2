...
% orbital elements
oe = zeros(6,1);
orbit_altitude = 568121;  % calculated for repeating ground track orbit
orbit_radius = consts.rEarth + orbit_altitude;

gamma_beam_Sun = 32/60*pi/180 / 2; % anglular size of the Sun, rad
S_spot_Sun = pi * (gamma_beam_Sun * orbit_altitude)^2;
...
m_required = -6; % required magnitude for demonstration
