function [t_vec, rv_ECI, maneuvers, formation_fuel_level] = continuous_control_constant_keeping(rv_ECI, T_maintenance, T_rude_control, consts, spacecraft, formation, mode)
